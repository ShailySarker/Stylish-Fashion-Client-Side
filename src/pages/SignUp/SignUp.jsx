        ...
        <div className="flex justify-between items-center lg:gap-0 bg-[#b7b0b00a] bg-opacity-75 backdrop-filter backdrop-blur-lg md:h-screen lg:px-20 md:px-9 px-6 lg:py-2 md:py-7 py-5">
            <div className="lg:w-[57%] md:w-2/3 w-11/12 lg:mx-0 mx-auto">
                ...
                <div className="text-center w-[100%]">
                    <h2 className="lg:text-4xl/normal md:text-3xl/normal text-2xl/normal font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-800 lg:mt-3 md:mt-2 mt-0">SignUp</h2>
                    <form onSubmit={handleSignUp} className="lg:mt-8 md:mt-5 mt-3">
                    ...
                    <p className="lg:w-[400px] md:w-[500px] text-gray-800 lg:mt-4 md:mt-3 mt-2 lg:text-base md:text-base text-sm mx-auto md:font-medium lg:mb-10">Already have an account? <span className="text-purple-800 lg:font-extrabold font-bold border-b-2 border-purple-800"><Link to="/login">Login</Link></span> now!</p>
                </div>
            </div>
