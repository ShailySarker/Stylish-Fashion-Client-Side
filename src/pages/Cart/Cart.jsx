      ...
      <div>
        {isLoading ? (
          ...
          <div className="w-full">
            <h2 className="lg:text-2xl/relaxed md:text-xl/relaxed text-lg/relaxed lg:my-40 md:my-28 my-20 text-black text-center font-semibold">
              ...
              <div className="lg:mt-16 md:mt-10 mt-8 flex flex-col lg:gap-4 md:gap-3 gap-2">
                ...
                <div className="flex justify-between">
                  ...
                  <p className="font-semibold lg:text-lg md:text-base text-sm">
                    {" "}
                    <span className="font-bold">$</span>{" "}
                    {(cartInfo?.subTotal * 0.05).toFixed(2)}
                  </p>
                </div>
                <div className="flex justify-between lg:pt-5 md:pt-4 pt-3 border-t-2">
                  <p className="font-semibold lg:text-2xl md:text-xl text-lg">
                    Total
                  </p>
                  <p className="font-bold lg:text-2xl md:text-xl text-lg">
                    <span className="font-bold">$</span>
                    {`${Math.round(cartInfo?.subTotal + cartInfo?.cartQuantity * 5 + cartInfo?.subTotal * 0.05)}`}{" "}
                  </p>
