...
const Products = () => {
  ...
  const handleColorChange = (selectedColor) => {
    setSelectedFilters((prevFilters) => {
      ...
      const newColors = isSelected
        ? prevFilters?.color.filter(
            (filterColor) =>
              filterColor?.colorName !== selectedColor?.colorName,
          )
    ...
    if (currentUser?._id) {
      try {
        const res = await dispatch(
          removeFromWishlist(currentUser?._id, productId),
        );
        if (res?.status === "success") {
          Swal.fire({
            position: "center",
  ...
  const isProductInWishlist = (productId) => {
    ...
    return (
      Array.isArray(wishlistInfo) &&
      wishlistInfo.some((item) => item?.selectedProductId === productId)
    );
  };
  ...
  const goToNextPage = () => {
    setCurrentPage((prevPage) =>
      Math.min(prevPage + 1, Math.ceil(allProducts.length / itemsPerPage)),
  ...
  return (
    <div className="lg:px-20 md:px-12 px-6 lg:mt-5 md:mt-4 mt-3">
      <div>
        <h1 className="lg:text-4xl/normal md:text-3xl/normal text-2xl/normal font-bold text-center text-black">
          All Products
        </h1>
          ...
          <div className="flex lg:flex-row flex-col lg:gap-12 lg:mt-12 md:mt-10 mt-7">
            ...
            <div className="lg:hidden visible lg:mb-0 md:mb-2 mb-[6px]">
              <button
                ...
                className="flex items-center gap-3 border-2 bg-purple-800 text-white rounded-xl md:px-5 px-4 py-1"
              >
                <IoFilter />
                  ...
                  <div className="relative lg:px-10 lg:py-8 md:px-10 md:py-7 px-4 py-5 rounded-xl bg-white md:w-[560px] w-11/12 md:h-[740px] h-[520px] overflow-y-auto mx-auto shadow-lg">
                    <div className="flex justify-between">
                      ...
                      <h2 className="w-[76%] text-center lg:text-3xl/normal md:text-2xl text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-800">
                        Want to apply different filters?
                      </h2>
                      <div className="w-[12%] flex justify-end">
                        <FaX
                          onClick={handleCloseModal}
                          className=" bg-purple-800 text-white p-1 md:w-7 md:h-7 w-5 h-5 rounded-full "
                        />
                      </div>
                    </div>
                        ...
                        <div className="md:mt-2 mt-[7px] flex flex-wrap items-center gap-x-4 md:gap-y-2 gap-y-[6px] font-medium text-black">
                          ...
                          <div className="flex flex-row gap-1">
                            <input
                              type="checkbox"
                              checked={
                                selectedFilters.sortBy === "Price Low to High"
                              }
                              onChange={() =>
                          ...
                          <div className="flex flex-row gap-1">
                            <input
                              type="checkbox"
                              checked={
                                selectedFilters.sortBy === "Price High to Low"
                              }
                              onChange={() =>
                        ...
                        <div className="md:mt-2 mt-[7px] flex flex-wrap items-center gap-x-4 md:gap-y-2 gap-y-[6px] font-medium text-black">
                          ...
                          <div className="flex flex-row  gap-1">
                            <input
                              type="checkbox"
                              onChange={() =>
                                handleSubCategoryChange("TopSkirtSet")
                              }
                            />
                            <p className="md:text-base text-sm font-medium">
                              Top Skirt Set
                          ...
                          <div className="flex flex-row  gap-1">
                            <input
                              type="checkbox"
                              onChange={() =>
                                handleSubCategoryChange("TopPantSet")
                              }
                            />
                            <p className="md:text-base text-sm font-medium">
                              Top Pant Set
                          ...
                          <div className="flex flex-row  gap-1">
                            <input
                              type="checkbox"
                              onChange={() =>
                                handleSubCategoryChange("TshirtPantSet")
                              }
                            />
                            <p className="md:text-base text-sm font-medium">
                              Tshirt Pant Set
                          ...
                          <div className="flex flex-row  gap-1">
                            <input
                              type="checkbox"
                              onChange={() =>
                                handleSubCategoryChange("WinterDressSet")
                              }
                            />
                            <p className="md:text-base text-sm font-medium">
                              Winter Dress Set
                        ...
                        <div className="md:mt-2 mt-[7px] flex flex-wrap items-center gap-x-4 md:gap-y-2 gap-y-[6px] font-medium text-black">
                          ...
                          <div className="flex flex-row  gap-1">
                            <input
                              type="checkbox"
                              onChange={() =>
                                handleBrandChange("PoloRalphLauren")
                              }
                            />
                            <p className="md:text-base text-sm font-medium">
                              Polo Ralph Lauren
                          ...
                          <div className="flex flex-row  gap-1">
                            <input
                              type="checkbox"
                              onChange={() =>
                                handleBrandChange("TheChildrensPlace")
                              }
                            />
                            <p className="md:text-base text-sm font-medium">
                          ...
                          <div className="flex flex-row  gap-1">
                            <input
                              type="checkbox"
                              onChange={() =>
                                handleBrandChange("TommyHilfighter")
                              }
                            />
                            <p className="md:text-base text-sm font-medium">
                              Tommy Hilfighter
