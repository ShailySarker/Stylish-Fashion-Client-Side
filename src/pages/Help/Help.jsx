    ...
    return (
        <div>
            <div className='bg-purple-800 lg:py-48 md:py-28 py-20'>
                <h1 className='lg:text-9xl md:text-8xl text-6xl text-white font-semibold text-center'>Help</h1>
            </div>
            <div className="lg:px-20 md:px-12 px-6 lg:mt-16 md:mt-14 mt-12">
                <div>
                    <h1 className="lg:text-4xl/normal md:text-3xl/normal text-2xl/normal font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-800">General Query Information</h1>
                </div>
                <div className="lg:mt-10 md:mt-8 mt-6 flex flex-col gap-3 ">
                    {dataOfFAQs?.map((faq) => (
