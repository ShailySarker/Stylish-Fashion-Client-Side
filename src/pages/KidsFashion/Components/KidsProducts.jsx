...
const KidsProducts = () => {
    ...
    useEffect(() => {
        const getKidsProducts = async () => {
            try {
                ...
                setFilteredKidsProducts(sortedProducts); // Initialize filteredProducts with all products
            } catch (error) {
    ...
    const prices = kidsProducts?.length ? kidsProducts?.map(product => product?.price) : [];
