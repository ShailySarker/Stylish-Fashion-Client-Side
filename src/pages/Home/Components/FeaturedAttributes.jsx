    ...
    return (
        <div className="lg:px-20 md:px-12 px-6 lg:mt-20 md:mt-16 mt-14">
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-6 md:gap-6 gap-5 lg:mt-12 md:mt-10 mt-7">
                <div className="bg-purple-200 lg:py-8 lg:px-6 md:py-6 md:px-5 py-5 px-4 rounded-2xl transition-transform duration-500 transform hover:scale-105 border-purple-800 border-2 hover:shadow-lg">
                    ...
                    <p className="text-black md:text-base/relaxed text-sm/relaxed text-center">Ensures durability and comfort by including the variety of materials such as cotton, linen, silk, and wool.</p>
                </div>
                <div className="bg-purple-200 lg:py-8 lg:px-6 md:py-6 md:px-5 py-5 px-4 rounded-2xl transition-transform duration-500 transform hover:scale-105 border-purple-800 border-2 hover:shadow-lg">
                    ...
                    <p className="text-black md:text-base/relaxed text-sm/relaxed text-center">Features the latest and exclusive fashion trends for men, women, and kids in reasonable price.</p>
                </div>
                <div className="bg-purple-200 lg:py-8 lg:px-6 md:py-6 md:px-5 py-5 px-4 rounded-2xl transition-transform duration-500 transform hover:scale-105 border-purple-800 border-2 hover:shadow-lg">
                    ...
                    <p className="text-black md:text-base/relaxed text-sm/relaxed text-center">Inclusive sizing for all body types including petite and plus-size clothing with stylish design.</p>
                </div>
                <div className="bg-purple-200 lg:py-8 lg:px-6 md:py-6 md:px-5 py-5 px-4 rounded-2xl transition-transform duration-500 transform hover:scale-105 border-purple-800 border-2 hover:shadow-lg">
                    ...
                    <p className="text-black md:text-base/relaxed text-sm/relaxed text-center">Eco-friendly materials and manufacturing processes which commit to reducing environmental impact</p>
                </div>
            </div>
        </div>
    );
