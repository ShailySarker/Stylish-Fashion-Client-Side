    ...
    return (
        <div className="lg:px-20 md:px-12 px-6 lg:mt-20 md:mt-16 mt-14">
            ...
            <div className="lg:mt-20 md:mt-16 mt-10 grid lg:grid-cols-5 md:grid-cols-3 grid-cols-2 md:gap-8 gap-3 lg:gap-6">
                <div className="bg-purple-200 rounded-xl lg:h-48 md:h-32 h-20 flex justify-center items-center shadow-lg text-center text-black border-2 border-purple-800 transition duration-300 ease-in-out hover:bg-purple-800 hover:text-white transform hover:scale-105">
