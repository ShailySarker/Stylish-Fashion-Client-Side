...
const NotFound = () => {
    return (
        <div className="lg:mt-12 md:mt-28 mt-20 flex justify-center items-center lg:gap-3 flex-col">
            <img className="lg:w-[400px] md:w-[380px] w-[300px] h-auto" src={banner} alt="Not Found Image" />
