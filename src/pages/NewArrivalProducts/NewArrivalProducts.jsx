...
import { FaHeart, FaRegHeart, FaX } from "react-icons/fa6";
...
const NewArrivalProducts = () => {
    ...
    // const currentItems = newArrivals.slice(indexOfFirstItem, indexOfLastItem);
    ...
    const goToNextPage = () => {
        setCurrentPage((prevPage) => Math.min(prevPage + 1, Math.ceil(newArrivals.length / itemsPerPage))); // Ensure currentPage doesn't exceed the total number of pages
    };
    ...
    return (
        <div className="lg:px-20 md:px-12 px-6 lg:mt-5 md:mt-4 mt-3">
            <div>
                <h1 className="lg:text-4xl/normal md:text-3xl/normal text-2xl/normal font-bold text-center text-black">New Arrival Products</h1>
