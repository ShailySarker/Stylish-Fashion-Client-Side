...
import { FaAngleLeft, FaAngleRight, FaHeart, FaRegHeart, FaX } from "react-icons/fa6";
...
const WomenProducts = () => {
    ...
    useEffect(() => {
        const getWomenProducts = async () => {
            try {
                ...
                setFilteredWomenProducts(sortedProducts); // Initialize filteredProducts with all products
            } catch (error) {
    ...
    const prices = womenProducts?.length ? womenProducts?.map(product => product?.price) : [];
    ...
    useEffect(() => {
        ...
        setFilteredWomenProducts(filtered);

    }, [selectedFilters, womenProducts]);
    ...
    return (
        <div className="lg:px-20 md:px-12 px-6 lg:mt-5 md:mt-4 mt-3">
            <div>
                <h1 className="lg:text-4xl/normal md:text-3xl/normal text-2xl/normal font-bold text-center text-black">Women Fashion</h1>
