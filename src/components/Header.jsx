    ...
    >
      ...
      <div className="flex items-center gap-12">
        ...
        <nav className="lg:flex hidden items-center gap-8 text-black text-[17px] font-semibold">
          <NavLink to="/menFashion" className={navLinkClass}>
            Men
          </NavLink>
          <NavLink to="/womenFashion" className={navLinkClass}>
            Women
          </NavLink>
          <NavLink to="/kidsFashion" className={navLinkClass}>
            Kids
          </NavLink>
          <NavLink
                    ...
                    <>
                      ...
                      <div className="py-1">
                        ...
                        <DropdownLink
                          ...
                          icon={<FaPlus className="text-purple-700" />}
                          label="Add Product"
                          onClick={() => setUserDropdownOpen(false)}
                        />
                        <DropdownLink
                          to="/admin/transactions"
                          icon={<FaDollarSign className="text-purple-700" />}
                          label="Transactions"
                          onClick={() => setUserDropdownOpen(false)}
                        />
                      </div>
