        ...
        {/* <div className="bg-gradient-to-r from-pink-600 to-purple-800 text-white flex flex-col gap-8 lg:mt-20 md:mt-16 mt-14"> */}
            <div className=" lg:py-11 md:py-8 py-6 text-white lg:flex lg:flex-row lg:justify-between grid md:grid-cols-2 grid-cols-1 lg:gap-0 md:gap-x-24 md:gap-y-14 gap-6 lg:pb-6 md:pb-2 pb-0 lg:px-12 md:px-7 px-5">
                ...
                <div>
                    ...
                    <div className="flex md:gap-20 gap-28 lg:mt-7 md:mt-5 mt-3">
                        ...
                        <div className="flex flex-col lg:gap-3 md:gap-2 gap-[6px] lg:text-lg md:text-base text-sm font-medium">
                            ...
                            <ul className="">
                                <NavLink to='/contactUs' className={({ isActive }) => isActive ? "border-b-2 border-white" : ""
                                }>Contact Us</NavLink>
                            </ul>
                            <ul className="">
                                <NavLink to='/help' className={({ isActive }) => isActive ? "border-b-2 border-white" : ""
                                }>Help</NavLink>
                            </ul>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div className="flex flex-col lg:gap-3 md:gap-2 gap-[6px] lg:text-lg md:text-base text-sm lg:mt-7 md:mt-5 mt-3 font-medium">
                        <ul className="">
                            <NavLink to='/termsAndConditions' className={({ isActive }) => isActive ? "border-b-2 border-white" : ""
                            }>Terms & Conditions</NavLink>
                        </ul>
                        <ul className="">
                            <NavLink to='/privacyPolicy' className={({ isActive }) => isActive ? "border-b-2 border-white" : ""
                            }>Privacy Policy</NavLink>
                        </ul>
                        <ul className="">
                            <NavLink to='/cancellationAndRefundPolicy' className={({ isActive }) => isActive ? "border-b-2 border-white" : ""
