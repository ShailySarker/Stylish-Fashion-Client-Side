...
const Footer = () => {
    ...
    return (
        ...
        {/* <div className="bg-gradient-to-r from-blue-700 to-purple-900 text-black flex flex-col gap-8 lg:mt-20 md:mt-16 mt-14"> */}
            ...
            <div className=" lg:py-11 md:py-8 py-6 text-black lg:flex lg:flex-row lg:justify-between grid md:grid-cols-2 grid-cols-1 lg:gap-0 md:gap-x-24 md:gap-y-14 gap-6 lg:pb-6 md:pb-2 pb-0 lg:px-12 md:px-7 px-5">
